...
const Chat = () =>{
    const [conversa, setConversa] = useState([
        { nome: 'Prof:', texto: 'Todos conseguiram fazer a atividade?', hora: '09:49' },
        { nome: 'Mathiro:', texto: 'Claro professor, muito fácil!', hora: '10:50' },
        { nome: 'Safadão:', texto: 'Sim professor, easy!', hora: '12:12' },
        { nome: 'Mathiro:', texto: 'Pai tá brabo, manda mais uma que eu tô com tempo sobrando.', hora: '15:31' }
    ]);
